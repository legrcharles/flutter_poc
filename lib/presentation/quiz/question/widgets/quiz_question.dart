...
class QuizQuestions extends StatelessWidget {
  ...
  const QuizQuestions(
      {required this.pageController, required this.questions, Key? key})
      : super(key: key);
              ...
              children: [
                    ...
                    return BlocBuilder<QuizQuestionBloc, QuizQuestionState>(
                      ...
                      return AnswerCard(
                          ...
                          onTap: () => context
                              ...
                              .add(UserAnswered(answer: answer)));
                    });
                  },
                )),
                BlocBuilder<QuizQuestionBloc, QuizQuestionState>(
                  ...
                  return Container(
                     ...
                     */
                      child: AppButton(
                        title: state.currentIndex + 1 < questions.length
                            ? LocaleKeys.quiz_button_next
                            : LocaleKeys.quiz_button_see_result,
                        onPressed: () => context
                            .read<QuizQuestionBloc>()
                            .add(NextQuestion()),
                      ));
